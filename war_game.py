...
class War_player(War_hand):
    ...
    def __str__(self):
        rep = "\t"+super(War_player, self).__str__()
...
class War_dealer(War_hand):
    ...
    def __init__(self, name, cash, dealer_bet=0, player=None):
        super(War_dealer, self).__init__(name)
        self.name = name
        self.cash = cash
    ...
    def __str__(self):
        rep = super(War_dealer, self).__str__()
        rep += "\n" + "Всего наличных: " + str(self.cash)
        return rep
...
class War_game(object):
    ...
    def __init__(self, names):
        ...
        for name in names:
            ...
            player = War_player(name, cash=cash_pl)
            self.players.append(player)
        self.dealer = War_dealer("Dealer", self.add_cash)
        self.deck = War_deck()
        self.deck.populate()
        self.deck.shuffle()
